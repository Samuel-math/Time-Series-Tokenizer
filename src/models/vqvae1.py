...
class DownsampleConvMeanPool(nn.Module):
...
class Encoder(nn.Module):
    def __init__(self, in_channels, num_hiddens, num_residual_layers, num_residual_hiddens, embedding_dim, compression_factor):
        ...
        if compression_factor == 4:
            self._conv_1 = DownsampleConvMeanPool(in_channels=in_channels,
                                                  out_channels=num_hiddens // 2,
                                                  pool_size=2)
            self._conv_2 = DownsampleConvMeanPool(in_channels=num_hiddens // 2,
                                                  out_channels=num_hiddens,
                                                  pool_size=2)
            ...
            self._conv_2 = DownsampleConvMeanPool(in_channels=num_hiddens // 2,
                                                  out_channels=num_hiddens,
                                                  pool_size=2)
            self._conv_A = DownsampleConvMeanPool(in_channels=num_hiddens,
                                                  out_channels=num_hiddens,
                                                  pool_size=2)
            self._conv_3 = nn.Conv1d(in_channels=num_hiddens,
                                     out_channels=num_hiddens,
            ...
            self._conv_2 = DownsampleConvMeanPool(in_channels=num_hiddens // 2,
                                                  out_channels=num_hiddens,
                                                  pool_size=2)
            self._conv_3 = DownsampleConvMeanPool(in_channels=num_hiddens,
                                                  out_channels=num_hiddens,
                                                  pool_size=3)
            ...
            self._conv_A = DownsampleConvMeanPool(in_channels=num_hiddens,
                                                  out_channels=num_hiddens,
                                                  pool_size=2)
            self._conv_B = DownsampleConvMeanPool(in_channels=num_hiddens,
                                                  out_channels=num_hiddens,
                                                  pool_size=2)
            self._conv_3 = nn.Conv1d(in_channels=num_hiddens,
                                     out_channels=num_hiddens,
...
class Decoder(nn.Module):
    def __init__(self, in_channels, num_hiddens, num_residual_layers, num_residual_hiddens, compression_factor, out_channels=1):
        ...
        if compression_factor == 4:
            ...
            self._conv_trans_1 = UpsampleConv(in_channels=num_hiddens,
                                              out_channels=num_hiddens // 2,
                                              scale_factor=2)

            self._conv_trans_2 = UpsampleConv(in_channels=num_hiddens // 2,
                                              out_channels=out_channels,
                                              scale_factor=2)
            ...
            self._conv_trans_A = UpsampleConv(in_channels=num_hiddens,
                                              out_channels=num_hiddens,
                                              scale_factor=2)
            ...
            self._conv_trans_2 = UpsampleConv(in_channels=num_hiddens,
                                              out_channels=num_hiddens,
                                              scale_factor=3)

            self._conv_trans_3 = UpsampleConv(in_channels=num_hiddens,
                                              out_channels=num_hiddens // 2,
                                              scale_factor=2)

            self._conv_trans_4 = UpsampleConv(in_channels=num_hiddens // 2,
                                              out_channels=out_channels,
                                              scale_factor=2)
            ...
            self._conv_trans_B = UpsampleConv(in_channels=num_hiddens,
                                              out_channels=num_hiddens,
                                              scale_factor=2)
