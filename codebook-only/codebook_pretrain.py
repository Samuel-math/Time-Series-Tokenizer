...
def parse_args():
    ...
    parser.add_argument('--codebook_ema', type=int, default=1, help='是否使用EMA更新码本')
...
def main():
    ...
    # 返回模型路径供后续使用
    return str(save_dir / f'{model_name}.pth')
